...
class ResCompany(models.Model):
    ...
    favicon = fields.Binary(string="Favicon", help="This field holds the image used to display a favicon on the system")

    @api.one
    @api.depends('favicon')
    def get_favicon(self):
        self.favicon_url = 'data:image/png;base64,' + str(self.favicon.decode('UTF-8'))
    ...
    def get_company_logo(self):
        self.company_logo_url = ('data:image/png;base64,' + str(self.logo.decode('UTF-8')))
