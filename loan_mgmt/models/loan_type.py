...
class LoanMgmtLoanType(models.Model):
    ...
    disburse_journal_id = fields.Many2one('account.journal', string="Disbursement Journal")
    ...
    emi_journal_id = fields.Many2one('account.journal', string="EMI Journal")
    emi_cash_journal_id = fields.Many2one('account.journal', string="EMI Cash Journal")
    emi_account_id = fields.Many2one('account.account', string="EMI Account")
